...
export default function EditJournalV2({ navigation, route }) {
  ...
  const fetchJournalEntry = () => {
    axios
      .get(`https://welltalk-mobile-backend.up.railway.app/journalGet/${journalID}`)
      .then(response => {
  ...
  const confirmSaveChanges = () => {
    axios
      .put(`https://welltalk-mobile-backend.up.railway.app/journal/${journalID}`, {
        title,
        type,
        date,
        mood,
  ...
  const confirmDelete = () => {
    axios
      .delete(`https://welltalk-mobile-backend.up.railway.app/journal/${journalID}`)
      .then(() => {
