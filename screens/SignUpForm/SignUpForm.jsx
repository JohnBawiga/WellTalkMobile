...
const SignupForm = () => {
  ...
  const sendSignupRequest = async (userData) => {
    try {
      const response = await axios.post('https://welltalk-mobile-backend.up.railway.app/signup', userData);
  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await axios.get(`https://welltalk-mobile-backend.up.railway.app/userByStudentID/${studentID}`, {
